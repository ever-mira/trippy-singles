<template>
  <div class="inline-flex items-center mt-1">
    <span class="text-gray-500 -mt.3">Checkbox Prototype</span>
    <label class="relative flex cursor-pointer items-center rounded-full p-3" for="checkbox-4" data-ripple-dark="true">
