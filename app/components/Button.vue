...
const baseClasses = 'text-white focus:outline-none rounded-xl rounded-lg !text-[.9rem] font-medium cursor-pointer text-center shadow-xs transition-all duration-100'
