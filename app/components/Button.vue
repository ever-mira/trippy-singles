...
const baseClasses = 'text-white focus:outline-none rounded-xl !text-[.9rem] font-semibold disabled:cursor-default cursor-pointer text-center shadow-sm transition-all duration-100 select-none'
