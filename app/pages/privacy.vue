<template>
  <div class="container mx-auto max-w-screen-xl mt-17 mb-60">
    ...
    <h2 class="text-2xl font-semibold mt-6 mb-3">1. Information We Collect</h2>
    ...
    <h2 class="text-2xl font-semibold mt-6 mb-3">2. How We Use Your Information</h2>
    <ul class="list-disc list-inside mb-4">
      <li>To provide and improve the Service.</li>
      <li>To communicate with you regarding your account.</li>
      <li>To personalize your experience.</li>
      <li>To ensure security and prevent fraud.</li>
      <li>To display TikTok uploads if you connect your TikTok account.</li>
    </ul>

    <h2 class="text-2xl font-semibold mt-6 mb-3">3. Sharing Your Information</h2>
    <p class="mb-4">
      We do not sell your personal information. We may share your data with third parties in certain circumstances:
    </p>
    <ul class="list-disc list-inside mb-4">
      <li>With your consent.</li>
      <li>To comply with legal obligations.</li>
      <li>To prevent harm or enforce our terms.</li>
    </ul>
    ...
    <h2 class="text-2xl font-semibold mt-6 mb-3">7. Changes to the Privacy Policy</h2>
    <p class="mb-4">
      We may update this policy from time to time. Any changes will be posted here, and continued use of the Service
      will constitute your acceptance of the updated policy.
    </p>
